...
def generate_launch_description():
    ...
    rrbot_gaazebo = os.path.join(
        get_package_share_directory('rrbot_gaazebo'),
        'worlds',
        'rrbot.world')
    ...
    gazebo = IncludeLaunchDescription(
                ...
                launch_arguments={'world': rrbot_gaazebo}.items(),
             )
    ...
    robot_controllers = os.path.join(get_package_share_directory("rrbot_gaazebo"),"config","gazebo_controllers.yaml")
